        ...
        <form onSubmit={handleSubmit} className="modal-body">
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              {errors.vehiculo_id && (
                <span className="error-message">{errors.vehiculo_id}</span>
              )}
            </div>

            <div className="form-group">
              <label htmlFor="chofer_id">
                Chofer {choferDisabled ? '(No requerido)' : '*'}
              </label>
              <select
                id="chofer_id"
                name="chofer_id"
              ...
              {errors.chofer_id && (
                <span className="error-message">{errors.chofer_id}</span>
              )}
            </div>
          </div>
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              />
              {errors.kilometros && (
                <span className="error-message">{errors.kilometros}</span>
              )}
            </div>
          </div>
